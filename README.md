...
## **A retro handheld with built in music playing capabilities!**
...
I absolutely love retro games and I absolutely love good music, but I dont have a handheld nor a music player I can use on the go, so I made this project. The PixelPlay is a complete handheld based off the GameBoy, which can both emulate GBA/SNES games, as well as play music through an audio jack. It is powered off a Raspberry Pi Zero 2 W.

---

##  Key Features

* The Brains: Raspberry Pi Zero 2W
* Firmware: Retropie
* Display: An 3.2in SPI TFT hat built for raspberryy pis.
* Audio: An I2S DAC system.
* Supports both wired headphones upto 128 ohm impedance and a built in speaker, using an amplifier and switching jack.
* Power Cicuit
    * TP4056 for micro USB charging.
    * DW01A + FS8205A for battery protection (over-discharge, short-circuit).
    * MT3608 boost converter to generate a stable 5V rail.
* Buttons: Includes D-Pad, A/B/X/Y, Start/Select, and two trigger pads.
* Custom Case: A 3D-printed enclosure that I designed in blender.
...
* Micro USB ---> TP4056 ---> Battery
* Battery protected using the standard DW01A and FS8205A circuit
* Battery ---> MT3608
* MT3608 outputs a stable 5V
* 5V ---> RPi

  
### 3. Audio System
This is a high-fidelity 4-wire audio chain made using the CJMCU4344.
* DAC: The Pi's I2S pins are routed to the CJMCU-4344 (CS4344) module.
* Output: The CS4344 outputs a line-level signal that can drive headphones from 16-124 OHM impedances.
...
**This results in a setup where the audio signals are routed to the inbuilt speaker when nothing is plugged into the switching jack, and when headphones are plugged in, direct output frm the I2S DAC**
...
|       | 3D PRINT(SHIPPING)                                                        | PRINTING LEGION              |                                  |          |                 |            | $6.00         |                                                                                                                                                                                                                                                                                                                                 |
|       |                                                                           |                              |                                  |          | TOTAL           |            | $76.88         |                                                                                                                                                                                                                                                                                                                                 |
